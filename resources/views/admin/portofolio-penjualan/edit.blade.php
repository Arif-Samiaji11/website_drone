...
@section('title', 'Kelola Portofolio Penjualan - Edit')
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 max-w-3xl">
  <h1 class="text-xl font-extrabold text-slate-900 mb-4">Kelola Portofolio Penjualan - Edit</h1>
  ...
  <form method="POST" action="{{ route('admin.portofolio-penjualan.update', $portofolio) }}" class="space-y-4">
    @csrf
    @method('PUT')
