...
@section('title', 'Kelola Portofolio Jasa Servis Drone - Edit')
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 max-w-3xl">
  <h1 class="text-xl font-extrabold text-slate-900 mb-4">Kelola Portofolio Jasa Servis Drone - Edit</h1>
  ...
  <form method="POST" action="{{ route('admin.portofolio-servis-drone.update', $portofolio) }}" class="space-y-4">
    @csrf
    @method('PUT')
    ...
    <div>
      ...
      <input name="cover" value="{{ old('cover', $portofolio->cover) }}"
             class="mt-1 w-full px-3 py-2 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-red-200">
