...
@section('title', 'Kelola Portofolio Jasa Darat - Edit')
...
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 max-w-3xl">
  <h1 class="text-xl font-extrabold text-slate-900 mb-4">Kelola Portofolio Jasa Darat - Edit</h1>
  ...
  <form method="POST" action="{{ route('admin.portofolio-darat.update', $portofolio) }}" class="space-y-4">
    @csrf
    @method('PUT')
