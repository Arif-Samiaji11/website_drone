...
<head>
  ...
  <title>Tambah Layanan Darat</title>
  @vite(['resources/css/app.css','resources/js/app.js'])
</head>
<body class="bg-slate-50 text-slate-900">
  <div class="max-w-2xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between">
      <h1 class="text-2xl font-extrabold">Tambah Layanan</h1>
    ...
    <div class="mt-6 bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
      <form method="POST" action="{{ route('admin.layanan-darat.store') }}" class="space-y-4">
        @csrf
