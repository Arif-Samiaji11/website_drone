<x-app-layout>
  ...
  <div x-data="{ showBookingModal: {{ $errors->any() ? 'true' : 'false' }} }" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Header Area -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold tracking-tight text-white uppercase" style="letter-spacing: 1px;">Order Unit Drone</h1>
        <p class="text-white/70 text-sm mt-2" style="font-family: 'Josefin Sans', sans-serif;">
          Ambil referensi produk dari Portofolio Penjualan (tabel portofolio_penjualans) dan ajukan order pembelian.
        </p>
      </div>
            ...
            <div class="vg-card flex flex-col justify-between">
              <div>
                ...
                <div class="text-xs text-[#00c7ff] mb-4" style="font-family: 'Josefin Sans', sans-serif; font-weight: 500;">
                  <i class="fa fa-shopping-bag mr-1"></i> {{ $p->lokasi }} @if($p->tanggal) · {{ $p->tanggal }} @endif
                </div>
                @if($p->deskripsi)
      ...
      <div x-show="showBookingModal" 
        ...
        <div class="vg-card w-full max-w-lg max-h-[90vh] overflow-y-auto no-scrollbar relative z-10 border border-white/10 shadow-2xl">
          ...
          <div class="font-bold text-xl text-white mb-1 tracking-wide uppercase">Kirim Permintaan Order</div>
          <div class="text-xs text-white/50 mb-6" style="font-family: 'Josefin Sans', sans-serif;">
            Isi form berikut untuk melakukan order pembelian unit drone Anda.
          </div>
          ...
          <form id="order-drone-form" method="POST" action="{{ route('order.drone.submit') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="col-span-2">
                <label class="vg-label">Lokasi Pengiriman</label>
                <div class="relative">
              ...
              <div class="col-span-2">
                <label class="vg-label">Catatan Spesifikasi / Keterangan</label>
                <textarea name="catatan" rows="3" class="vg-input" placeholder="Tulis spesifikasi unit atau catatan tambahan jika ada...">{{ old('catatan') }}</textarea>
              </div>
            </div>
    ...
    <!-- Kanan Bawah: Pesan Sekarang Button (Membuka Modal) -->
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const form = document.getElementById('order-drone-form');
      if (form) {
