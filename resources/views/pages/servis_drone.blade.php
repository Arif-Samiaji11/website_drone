<x-app-layout>
  ...
  <div x-data="{ showBookingModal: {{ $errors->any() ? 'true' : 'false' }} }" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <!-- Header Area -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold tracking-tight text-white uppercase" style="letter-spacing: 1px;">Servis Unit Drone</h1>
        <p class="text-white/70 text-sm mt-2" style="font-family: 'Josefin Sans', sans-serif;">
          Ambil referensi servis dari Portofolio Servis Drone (tabel portofolio_servis_drones) dan ajukan servis.
        </p>
      </div>
      ...
      <div class="space-y-6">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          @forelse($portofolios as $p)
            <div class="vg-card flex flex-col justify-between">
              <div>
                <div class="font-bold text-lg text-white mb-2 tracking-wide">{{ $p->judul }}</div>
                <div class="text-xs text-[#00c7ff] mb-4" style="font-family: 'Josefin Sans', sans-serif; font-weight: 500;">
                  <i class="fa fa-wrench mr-1"></i> {{ $p->lokasi }} @if($p->tanggal) · {{ $p->tanggal }} @endif
                </div>
                @if($p->deskripsi)
              ...
              <div class="text-xs text-white/40 pt-4 border-t border-white/5" style="font-family: 'Josefin Sans', sans-serif;">
      ...
      <div x-show="showBookingModal" 
        ...
        <!-- Modal Content Card -->
        <div class="vg-card w-full max-w-lg max-h-[90vh] overflow-y-auto no-scrollbar relative z-10 border border-white/10 shadow-2xl">
          ...
          <div class="font-bold text-xl text-white mb-1 tracking-wide uppercase">Kirim Permintaan Servis</div>
          <div class="text-xs text-white/50 mb-6" style="font-family: 'Josefin Sans', sans-serif;">
            Isi form berikut untuk melakukan servis unit drone Anda.
          </div>
          ...
          <form id="servis-drone-form" method="POST" action="{{ route('servis.drone.submit') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div class="col-span-2">
                <label class="vg-label">Lokasi Penjemputan / Servis</label>
                <div class="relative">
              ...
              <div class="col-span-2">
                <label class="vg-label">Catatan Keluhan / Keterangan</label>
                <textarea name="catatan" rows="3" class="vg-input" placeholder="Tulis keluhan drone atau catatan tambahan jika ada...">{{ old('catatan') }}</textarea>
              </div>
            </div>
    ...
    <!-- Kanan Bawah: Servis Sekarang Button (Membuka Modal) -->
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      const form = document.getElementById('servis-drone-form');
      if (form) {
