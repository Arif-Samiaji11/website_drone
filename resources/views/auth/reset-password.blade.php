...
<body>
  <div class="mriki-bg">
    ...
    <section class="mriki-card">
      <div class="mriki-card__header">
        ...
        <div>
          <h1 class="mriki-card__title">Reset Password</h1>
          <p class="mriki-card__subtitle">Atur ulang password akun kamu.</p>
        </div>
      </div>
      ...
      <div class="mriki-card__body">
        <form method="POST" action="{{ route('password.store') }}">
          ...
          <div class="mriki-row">
            ...
            <button type="submit" class="mriki-btn">Simpan Password Baru</button>
          </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // 3. Validasi Kesamaan Konfirmasi Password
      ...
      // Mencegah submit jika inputan tidak valid
      form.addEventListener('submit', function(event) {
        ...
        if (!isEmailValid || !isPasswordValid || !isConfirmValid) {
          event.preventDefault(); // Batalkan submit data
          
          // Fokus otomatis ke input bermasalah pertama
          if (!isEmailValid) emailInput.focus();
          else if (!isPasswordValid) passwordInput.focus();
          else if (!isConfirmValid) passwordConfirmInput.focus();
        }
      });
    });
  </script>
